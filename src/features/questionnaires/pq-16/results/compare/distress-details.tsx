...
export const DistressDetails = (props: Props) => {
  ...
  useLayoutEffect(() => {
    ...
    legend
      ...
      .attr('cx', 45)
      .attr('cy', -44)
      .classed('fill-forest-green-500', true);
    legend
    ...
    legend
      ...
      .attr('cx', 0)
      .attr('cy', -44)
      .classed('fill-forest-green-700', true);
    legend
      .insert('text', ':first-child')
      .text(`T${nextT}`)
      .attr('x', 55)
    ...
    svg
      ...
      .append('line')
      .attr('x1', function (d) {
        const score = parseInt(d.prevRecord.score ?? '0');
        return x(score);
      })
      .attr('x2', function (d) {
        const score = parseInt(d.nextRecord.score ?? '0');
        return x(score);
      })
      .attr('y1', function (d) {
      ...
      .classed('stroke-2 stroke-forest-green-300', true);
