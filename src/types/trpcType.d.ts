 ...
 */
export type TProcedure<T, U> = AppRouter['_def']['procedures'][T][U];

export type InferProcedureInput<T, U> = inferProcedureInput<TProcedure<T, U>>;
/**
 ...
 */
export type InferQueryInput<TRouteKey extends TProcedure> = inferProcedureInput<
  AppRouter['_def']['procedures'][TRouteKey]
>;

type UserInput = InferQueryInput<'therapist'>;
/**
